...
const WeavingLogin = () => {
    ...
    const { isAuthenticated, signInWithGoogle, signInWithLine, signInWithEmail, signUpWithEmail, signInOffline } = useAuth();
    ...
    const handleLineLogin = async () => {
        ...
        if (result?.error) {
            setError(result.error.message || 'LINE 登入失敗');
        }
        setLoading(false);
    };
                ...
                {mode !== 'forgot' && (
                    <div style={styles.socialSection}>
                        ...
                        <div style={styles.socialRow}>
                            ...
                            {/* LINE (因 Supabase 官方尚未原生支援暫停使用)
                            <button style={{ ...styles.socialBtn, background: '#06C755' }} onClick={handleLineLogin}>
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
